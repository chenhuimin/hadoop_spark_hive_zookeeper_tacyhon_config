...
export JAVA_HOME=/opt/apps/jdk1.8.0_66
export JAVA="${JAVA_HOME}/bin/java"
export TACHYON_RAM_FOLDER=/opt/apps/data/tachyon/ramdisk
export TACHYON_MASTER_ADDRESS=${TACHYON_MASTER_ADDRESS:-chenhuimin03.localdomain}
#export TACHYON_UNDERFS_ADDRESS=${TACHYON_UNDERFS_ADDRESS:-${TACHYON_HOME}/underFSStorage}
export TACHYON_UNDERFS_ADDRESS=${TACHYON_UNDERFS_ADDRESS:-hdfs://ns1}
#export HADOOP_HOME=/opt/apps/hadoop-2.7.1
#export HADOOP_TACHYON_CLASSPATH=$($HADOOP_HOME/bin/hadoop classpath)
#export TACHYON_CLASSPATH=${TACHYON_CLASSPATH:-$HADOOP_TACHYON_CLASSPATH}

export TACHYON_WORKER_MEMORY_SIZE=${TACHYON_WORKER_MEMORY_SIZE:-512MB}
...
export TACHYON_JAVA_OPTS+="
  ...
  -Dtachyon.zookeeper.address=chenhuimin01.localdomain:2181,chenhuimin02.localdomain:2181,chenhuimin03.localdomain:2181
"
